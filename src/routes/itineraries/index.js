...
async function action({ locale, fetch }) {
  ...
  const endpoint = `${JSON_API_URL}/${drupalLocale}/jsonapi/taxonomy_term/audio_itinerary?filter[field_is_parent][value]=1&sort=weight&include=field_image,field_background_image`;
